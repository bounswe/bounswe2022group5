                ...
                <div className="discussion-avatar-body">
                    ...
                    <div style={{ width: "100%" }}>
                        ...
                        <div className="discussion-body-votes">
                            <div>{post?.body}</div>
                            <Vote item={post} setItem={setPost} itemType="post"/>
							...
							<div className="discussion-comment">
                                ...
                                <div className="discussion-comment-container">
                                    ...
                                    <div className="discussion-comment-body">
                                        ...
                                        <Vote item={item?.comment} setItem={getCommentSetter(item?.comment?.id)} className="discussion-vote" itemType="comment"/>
                                    </div>

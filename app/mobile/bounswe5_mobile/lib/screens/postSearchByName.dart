...
class PostSearchByNamePage extends StatefulWidget {
  const  PostSearchByNamePage({Key? key, required String this.token}) : super(key: key);
  final String token;

  @override
  State<PostSearchByNamePage> createState() => _PostSearchByNamePageState();
}

class _PostSearchByNamePageState extends State<PostSearchByNamePage> {

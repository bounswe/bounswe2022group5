...
class UpvotedArticlesOverviewScreen extends StatefulWidget {
  UpvotedArticlesOverviewScreen({required this.activeUser});
  final User activeUser;

  @override
  _UpvotedArticlesOverviewScreenState createState() => _UpvotedArticlesOverviewScreenState();
}
class _UpvotedArticlesOverviewScreenState extends State<UpvotedArticlesOverviewScreen> {
  ...
  Future<void> fetchData() async {
    try{
      List<dynamic> articlesInfo = await ApiService().getUpvotedArticles(widget.activeUser, _pageNumber, _numberOfArticlesPerRequest);

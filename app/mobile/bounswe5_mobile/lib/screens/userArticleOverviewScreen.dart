...
class UserArticlesOverviewScreen extends StatefulWidget {
  UserArticlesOverviewScreen({required this.activeUser});
  final User activeUser;

  @override
  _UserArticlesOverviewScreenState createState() => _UserArticlesOverviewScreenState();
}
class _UserArticlesOverviewScreenState extends State<UserArticlesOverviewScreen> {

...
class UpvotedPostsOverviewScreen extends StatefulWidget {
  UpvotedPostsOverviewScreen({required this.activeUser});
  final User activeUser;

  @override
  _UpvotedPostsOverviewScreenState createState() => _UpvotedPostsOverviewScreenState();
}
class _UpvotedPostsOverviewScreenState extends State<UpvotedPostsOverviewScreen> {
  ...
  Future<void> fetchData() async {
    try{
      List<dynamic> postInfo = await ApiService().getUpvotedPosts(widget.activeUser, _pageNumber, _numberOfPostsPerRequest);

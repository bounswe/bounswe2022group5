...
class TestViews(TestCase):
    ...
    def test_post_POST(self):
        ...
        self.assertEquals(post__.title, 'title_updated')
        self.assertEquals(post__.body, 'body_updated')
        self.assertEquals(post__.category, self.category2)
        self.assertEquals(post__.country, 'Italy')

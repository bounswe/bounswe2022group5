...
* Note that the issues and pull requests noted above includes the time span between Milestone 2 and Final Milestone. Other issues and pull requests can be found on previous individual reports such as [Milestone 1 Report](https://github.com/bounswe/bounswe2022group5/blob/master/deliverables/CMPE451_Milestone_1/M1_Report_Group5.md) and [Milestone 2 Report](https://github.com/bounswe/bounswe2022group5/blob/master/deliverables/CMPE451_Milestone_2/M2_Report_Group5.md).
